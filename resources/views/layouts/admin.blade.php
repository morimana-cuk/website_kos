...
<div id="wrapper">
    <!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" style="background-color: #D2B48C; color: #000;" id="accordionSidebar">

        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard') }}" style="color: #000;">
        ...
        <li class="nav-item {{ Nav::isRoute('index_laporan') }}">
            <a class="nav-link" href="{{ route('index_laporan') }}">
        ...
        <li class="nav-item {{ Nav::isRoute('index_komplain') }}">
            <a class="nav-link" href="{{ route('index_komplain') }}">
                <i class="fas fa-fw fa-exclamation-circle"style="color: #000;" ></i>
                <span style="color: #000;">{{ __(' ajukan komplain') }}</span></a>
        </li>

        <li class="nav-item {{ Nav::isRoute('index_laporan') }}">
            <a class="nav-link" href="{{ route('index_laporan') }}">
                <i class="fas fa-fw fa-dollar-sign"style="color: #000;" ></i>
                <span style="color: #000;">{{ __('pembayaran') }}</span></a>
        </li>
